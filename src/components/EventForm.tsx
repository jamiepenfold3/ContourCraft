...
const categoryMeta: Array<{ key: CategoryKey; label: string }> = [
  ...
  { key: "food", label: "Food" },
  { key: "wineries", label: "Wine farms / breweries" },
...
const emptyCategories = (): Record<CategoryKey, CategoryDraft> => ({
  ...
  food: { enabled: false, heading: "", description: "", gallery: [], strava: emptyStrava() },
  wineries: { enabled: false, heading: "", description: "", gallery: [], strava: emptyStrava() },
